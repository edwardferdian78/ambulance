<body>
    ...
    <!-- <div class="wrap">
        <nav id="w0" class="fixed-top navbar-expand-lg navbar-dark- bg-dark navbar">
<div class="container">
<a class="navbar-brand" href="/admin/">My Application</a>
<button type="button" class="navbar-toggler" data-toggle="collapse" data-target="#w0-collapse" aria-controls="w0-collapse" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
<div id="w0-collapse" class="collapse navbar-collapse">
<ul id="w1" class="navbar-nav ml-auto nav"><li class="nav-item"><a class="nav-link" href="/admin/site/index">Home</a></li>
<li><form action="/admin/site/logout" method="post">
<input type="hidden" name="_csrf-backend" value="1EKfvzTnLRvik1JPc8FY0ndseStzfrUfl43UGNwEWZPgGsr5R4h9XpvFIQgLinXlDg9KehEGhUzW2eZRrUVrqg=="><button type="submit" class="btn btn-link logout">Logout (edo)</button></form></li></ul></div>
</div>
</nav> -->
    ...
    <footer class="footer">
        <div class="container">
            <p class="pull-left">© My Application 2021</p>
    ...
    <div>
        <div id="yii-debug-toolbar" class="yii-debug-toolbar yii-debug-toolbar_position_bottom" data-height="50" style="display: block;">
            <div class="yii-debug-toolbar__resize-handle"></div>
            <div class="yii-debug-toolbar__bar">
                <div class="yii-debug-toolbar__block yii-debug-toolbar__title">
                    <a href="/admin/debug/default/index">
                ...
                <div class="yii-debug-toolbar__block">
                    <a href="/admin/debug/default/view?panel=config&amp;tag=6069da2bb37f7" tabindex="-1">
                        <span class="yii-debug-toolbar__label">2.0.41.1</span>
                        PHP
                        <span class="yii-debug-toolbar__label">7.3.27</span>
                    </a>
                </div>
                <div class="yii-debug-toolbar__block">
                    <a href="/admin/debug/default/view?panel=request&amp;tag=6069da2bb37f7" title="Status code: 404 Not Found" tabindex="-1">Status <span class="yii-debug-toolbar__label yii-debug-toolbar__label_important">404</span></a>
                </div>
                <div class="yii-debug-toolbar__block">
                    <a href="/admin/debug/default/view?panel=router&amp;tag=6069da2bb37f7" title="Action: yii\web\ErrorAction::run()" tabindex="-1">Route <span class="yii-debug-toolbar__label">site/error</span></a>
                </div>

                <div class="yii-debug-toolbar__block">
                    <a href="/admin/debug/default/view?panel=log&amp;tag=6069da2bb37f7" title="Logged 20 messages,&nbsp;1 error" tabindex="-1">Log
                        <span class="yii-debug-toolbar__label">20</span>
                    </a>
                    <a href="/admin/debug/default/view?panel=log&amp;tag=6069da2bb37f7&amp;Log%5Blevel%5D=1" title="1 error" tabindex="-1">
                        <span class="yii-debug-toolbar__label yii-debug-toolbar__label_important">1</span>
                    </a>
                </div>
                <div class="yii-debug-toolbar__block">
                    <a href="/admin/debug/default/view?panel=profiling&amp;tag=6069da2bb37f7" title="Total request processing time was 632 ms" tabindex="-1">Time <span class="yii-debug-toolbar__label yii-debug-toolbar__label_info">632 ms</span></a>
                    <a href="/admin/debug/default/view?panel=profiling&amp;tag=6069da2bb37f7" title="Peak memory consumption" tabindex="-1">Memory <span class="yii-debug-toolbar__label yii-debug-toolbar__label_info">7.749 MB</span></a>
                </div>
                <div class="yii-debug-toolbar__block">
                    <a href="/admin/debug/default/view?panel=db&amp;tag=6069da2bb37f7" title="Executed 7 database queries which took 146 ms." tabindex="-1">
                        DB <span class="yii-debug-toolbar__label yii-debug-toolbar__label_info">7</span> <span class="yii-debug-toolbar__label">146 ms</span>
                    </a>
                </div>
                <div class="yii-debug-toolbar__block">
                    <a href="/admin/debug/default/view?panel=event&amp;tag=6069da2bb37f7" tabindex="-1">Events <span class="yii-debug-toolbar__label">30</span></a>
                </div>
                <div class="yii-debug-toolbar__block">
                    <a href="/admin/debug/default/view?panel=assets&amp;tag=6069da2bb37f7" title="Number of asset bundles loaded" tabindex="-1">Asset Bundles <span class="yii-debug-toolbar__label yii-debug-toolbar__label_info">5</span></a>
                </div>
                <div class="yii-debug-toolbar__block">
                    <a href="/admin/debug/default/view?panel=user&amp;tag=6069da2bb37f7" tabindex="-1">
                ...
                ajax(url, {
                    success: function(xhr) {
                        ...
                        if (typeof(Event) === 'function') {
                            event = new Event('yii.debug.toolbar_attached', {
                                'bubbles': true
                            });
                        } else {
    ...
    <script src="/admin/assets/7fca60df/jquery.js"></script>
    <script src="/admin/assets/7fda1b14/yii.js"></script>
    <script src="/admin/js/sb-admin-2.min.js"></script>
    <script src="/admin/assets/4c4e011/js/bootstrap.bundle.js"></script>
